...
public class FragmentFilms extends Fragment {
    ...
    private final List<Film> listFilm = new ArrayList<>();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String s) {
                listFilm.clear();
                jsonURL = String.format("http://www.omdbapi.com/?apikey=7e9fe69e&s=%s&page=1", s);
                GetData getData = new GetData();
                getData.execute();
...
//                    film.setFilmGenre(object.getString("Genre"));
//                    film.setFilmDirector(object.getString("Director"));
//                    film.setFilmWriter(object.getString("Writer"));
//                    film.setFilmActors(object.getString("Actors"));
//                    film.setFilmCountry(object.getString("Country"));
//                    film.setFilmLanguage(object.getString("Language"));
//                    film.setFilmProduction(object.getString("Production"));
//                    film.setFilmRelease(object.getString("Released"));
//                    film.setFilmRuntime(object.getString("Runtime"));
//                    film.setFilmAwards(object.getString("Awards"));
//                    film.setFilmRating(object.getString("Rating"));
//                    film.setFilmPlot(object.getString("Plot"));
